...
Passionate full-stack developer skilled in MERN and PHP Laravel. 
Experienced in building scalable web applications and RESTful APIs. 
Proficient in frontend design and backend architecture with modern development practices. 
Always eager to learn new technologies and deliver high-performance solutions.
              </p>
            </motion.div>
                ...
                <Card className="h-full border-primary/10 bg-card/50 backdrop-blur-sm">
                  <CardContent className="pt-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        <p className="font-medium">Javascript, Laravel Full Stack Developer</p>
                        <p className="text-sm text-muted-foreground">
                          IT Park Software Company
                        </p>
                        <p className="text-sm text-muted-foreground">
